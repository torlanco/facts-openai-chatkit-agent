  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-background">
      ...
      <header className="w-full border-b border-muted py-4 px-6 flex items-center justify-between">
        ...
        <button
          onClick={toggleTheme}
          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-muted hover:bg-facts-yellow-bright hover:text-facts-black transition-colors"
        ...
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="hover:text-facts-yellow transition-colors"
            >
              factscloud.com
            </a>
